...
namespace Pregunta1_PaolaDeras
{
    public class Asignatura : Alumno, IAsignatura
    {
        ...
        public void Imprimir()
        {
            ...
            Console.WriteLine($"Nota Final (método sin parámetros): {notaFinal} - {MensajeNotaFinal(notaFinal)}");
            Console.WriteLine($"Nota Final (método con parámetros): {CalcularNotaFinal(N1, N2, N3)} - {MensajeNotaFinal(CalcularNotaFinal(N1, N2, N3))}");
        }
